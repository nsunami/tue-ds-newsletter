...
export const StripeWelcomeEmail = () => (
  <Html>
    <Head />
    <Preview>PAR Data Steward Newsletter 2024-10-18</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>PAR Data Steward Newsletter October 2024</Section>
        <Section style={box}>
          <Img
        ...
        <Section style={box}>
          ...
          <Text style={paragraph}>
            ...
            strictly targeted to researchers. We plan to send updates twice per
            year only.
          </Text>
